    ...
    products: [
      {
        name: "6 Cheesestick",
        price: 10,
        description: "6 pieces of crispy cheesesticks",
        owner: "nat",
        image: "/images/products/cheesestick.jpg",
        is_available: true,
        options: [],
      },
      {
      ...
      },
      {
        name: "Goto",
        price: 35,
        description: "Rich rice porridge with beef tripe",
        owner: "mama",
      ...
      },
      {
        name: "Waffle",
        price: 25,
        description: "Classic waffle with your choice of filling",
        owner: "nat",
        image: "/images/products/waffle.jpg",
        is_available: true,
        options: [
          { group: "Filling", name: "Hotdog", price: 0, is_available: true },
          { group: "Filling", name: "Cheese", price: 0, is_available: true },
        ],
      },
    ],
  },
